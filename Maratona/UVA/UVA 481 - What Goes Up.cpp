...
//Link da questão: https://uva.onlinejudge.org/index.php?option=com_onlinejudge&Itemid=8&page=show_problem&problem=422
//OBS: find_lis was taken from LIS's page on wikipedia
//OBS: find_lis foi retirada da página de LIS do wikipédia
